...
export default function FloatingCallButton() {
  return (
    <aside aria-label="Quick Phone Call" className="fixed bottom-6 right-6 z-40 md:hidden flex flex-col items-end">
      <a
        href="tel:6382256206"
        className="flex items-center gap-2 bg-[#F26B5E] hover:bg-[#D9574D] text-[#FFF0D5] pl-3.5 pr-4 py-3 rounded-full shadow-md transition-all duration-300 transform hover:scale-105 active:scale-95"
